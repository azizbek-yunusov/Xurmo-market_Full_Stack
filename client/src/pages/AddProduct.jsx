...
const AddProduct = () => {
  return (
    <div className="min-h-screen bg-purple-400 flex justify-center items-center -z-10 ">
      ...
      <div className="w-40 h-40 absolute -z-10 bg-purple-300 rounded-full top-0 right-12 hidden md:block"></div>
      <div className="w-20 h-40 absolute -z-10 bg-purple-300 rounded-full bottom-20 left-10 transform rotate-45 hidden md:block"></div>
    </div>
  );
};
