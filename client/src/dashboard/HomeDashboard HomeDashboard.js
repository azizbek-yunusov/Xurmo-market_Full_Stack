            ...
            <div className="md:col-span-2 xl:col-span-1">
              <div className="rounded bg-gray-200 p-3">
                <div className="flex justify-between py-1 text-black dark:text-white">
                  ...
                  <svg
                    className="h-4 fill-current text-gray-600 0 cursor-pointer"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <tbody className="bg-white divide-y ">
                    <tr className="bg-gray-50 hover:bg-gray-100  text-gray-700 ">
                      ...
                      <td className="px-4 py-3 text-xs">
                        <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full  dark:text-green-100">
                          {" "}
                          Approved{" "}
                        </span>
                      </td>
                    ...
                    <tr className="bg-gray-50 hover:bg-gray-100  text-gray-700 ">
                      ...
                      <td className="px-4 py-3 text-xs">
                        <span className="px-2 py-1 font-semibold leading-tight text-gray-700 bg-gray-100 rounded-full  dark:bg-gray-700">
                          {" "}
                          Expired{" "}
                        </span>
                      </td>
          ...
          <div className="mt-8 mx-4">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <form className="p-6 flex flex-col justify-center">
                ...
                <button
                  type="submit"
                  className="md:w-32 bg-blue-600  text-white font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 dark:hover:bg-gray-200 transition ease-in-out duration-300"
                >
                  Submit
                </button>
              </form>
