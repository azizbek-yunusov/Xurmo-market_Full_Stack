...
const ListProductCard = (props) => {
  ...
  return (
    <>
      <div className="grid grid-cols-9 overflow-hidden w-full relative tranistion_normal md:my-2 hover:shadow-xl md:h-[200px] h-[200px] md:border border-gray-200 hover:border-gray-50 md:rounded-xl rounded-md md:p-5 p-3 md:px-4">
        {discount > 0 && (
