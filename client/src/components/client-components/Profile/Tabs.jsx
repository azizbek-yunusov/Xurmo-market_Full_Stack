...
const Tabs = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="w-full flex justify-center items-center xl:-mt-11 md:mt-4 mt-2 rounded-xl bg-[#ffffff4d] backdrop-blur-lg py-3 md:border border-gray-200 md:px-7 px-3">
