                  ...
                  <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                    <li>
                      ...
                      >
                        ...
                        <BsFacebook className="md:text-xl text-indigo-500" />
                      </a>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <BsInstagram className="md:text-xl text-red-500" />
                      </a>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <BsTwitter className="md:text-xl text-light-blue-400" />
                      </a>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <BsTelegram className="md:text-xl text-light-blue-400" />
                      </a>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <BsYoutube className="md:text-xl text-red-400" />
                      </a>
                    </li>
                  </ul>
                </div>
                    ...
                    <ul className="mt-8 space-y-4 text-sm">
                      <li>
                        <a
                          ...
                          href="/"
                        >
                          <BsEnvelope className="md:text-xl" />
                      ...
                      <li>
                        <a
                          ...
                          href="/"
                        >
                          <BiPhoneCall className="md:text-xl" />
                          <span className="text-gray-700">0123456789</span>
                        </a>
                      </li>

                      <li className="flex items-start justify-center gap-1.5 sm:justify-start">
                        <HiOutlineLocationMarker className="md:text-3xl" />
