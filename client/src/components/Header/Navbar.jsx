    ...
    <>
      ...
      >
        <div className="container-full  grid lg:grid-cols-12 md:pb-2 md:pt-[14px] py-1">
          <div className="lg:col-span-4 xl:col-span-3 flex justify-between items-center mr-2">
            <Link
              to="/"
          ...
          <div className="hidden lg:col-span-2 xl:col-span-3 lg:flex justify-end items-center">
            <ul className="flex justify-between items-center my-1">
              ...
              <li className="xl:ml-4 md:ml-[6px] ml-3 -mt-1">
      ...
      <div
        className={`bg-white lg:hidden border-b border-b-transparent ${
          isTop ? "" : "sticky top-0 w-full z-50 shadow-md border-b-gray-300"
        }`}
      >
