...
const VerifyModal = () => {
  ...
  return (
    <div className="flex_col items-center">
      <h1 className="text-3xl font-semibold md:mb-7 mb-5">{t("otp-verification")}</h1>
        ...
        {otp.map((value, index) => (
          <div key={index} className="w-16 h-16 md:mx-2 mx-1">
            <input
              ...
              className={`w-full h-full flex flex-col items-center justify-center text-center px-5 outline-none rounded-2xl border-2 ${
                error || isError ? "border-red-500" : "border-gray-300"
              } text-lg bg-white focus:bg-gray-50 focus:border-none focus:ring-2 ring-orange-400`}
