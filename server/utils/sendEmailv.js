...
const sendEmail = (to, url, txt) => {
  ...
  const mailOptions = {
    ...
    html: `
            ...
            <p>Congratulations! You're almost set to start using TexnoRoom.
                Just click the button below to validate your email address.
            </p>
            
            <a href=${url} style="background: ff8400; text-decoration: none; color: white; padding: 10px 20px; margin: 10px 0; display: inline-block;">${txt}</a>
